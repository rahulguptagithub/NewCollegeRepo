...
<html:form action="/admissionSubmit" method="post" enctype="multipart/form-data">

<div class="container">
<table>
<caption ><h1>Student Admission Window</h1></caption>
...
<td><td><html:text property="formNo"></html:text></td></td>
</tr>
...
<tr>
<td><label for="fname">Father's/Guardian Name(Please Specify)</label></td>
...
<tr>
  ...
  <td align="right"><label for="fname">Upload Student Image</label></td>
  <td colspan="2"><html:file property="photo"></html:file></td>
  
  </tr>
  
<tr>
<td><label for="fname">Candidate Date Of Birth(DD/MM/YYYY)</label></td>
<td><html:text property="dob" onclick="javascript:showCal('Calendar2')"></html:text></td>
<td align="center"><label for="fname">Category</label></td>
<td colspan="2">
<html:radio property="category" value="Gen"><label for="fname">GEN</label></html:radio>
<html:radio property="category" value="OBC"><label for="fname">OBC</label></html:radio>

<html:radio property="category" value="SC"><label for="fname">SC</label></html:radio>
<html:radio property="category" value="ST"><label for="fname">ST</label></html:radio>
</td>

</tr>
<tr><td colspan="4"><hr color="#ff9933"></td></tr>
<tr><td colspan="4" align="center"><label for="fname">Correspondence Address</label></td></tr>
<tr><td colspan="4"><hr color="green"></td></tr>
...
<tr><td colspan="4"><hr color="#ff9933"></td></tr>
<tr><td colspan="3" align="center"><label for="fname">Permanent Address</label></td>
<td align="center"><html:checkbox property="permanentAdd" value="same" styleId="permanentAddId"  ></html:checkbox></td>
</tr>
...
<tr><td colspan="4"><hr color="#ff9933"></td></tr>
<tr><td colspan="4" align="center"><label for="fname">Academic Qualifications</label></td></tr>
<tr><td colspan="4"><hr color="green"></td></tr>

<tr><td><label for="fname">Exam Passed</label></td><td><label for="fname">Passing Year</label></td><td><label for="fname">School/College Name</label></td><td><label for="fname">Board</label></td><td><label for="fname">Marks(%)</label></td></tr>
<tr>
...
<td><html:text property="passedYear1"></html:text></td><td><html:text property="instituteName1"></html:text></td><td><html:text property="board1"></html:text></td><td><html:text property="marks1"></html:text></td>
</tr>
<tr>
...
<td><html:text property="passedYear2"></html:text></td><td><html:text property="instituteName2"></html:text></td><td><html:text property="board2"></html:text></td><td><html:text property="marks2"></html:text></td>
</tr>
...
<td><html:text property="passedYear3"></html:text></td><td><html:text property="instituteName3"></html:text></td><td><html:text property="board3"></html:text></td><td><html:text property="marks3"></html:text></td>
</tr>

<tr>
<td><label for="fname">Name of Documents Submitted(Seperate by coma(,))</label></td>
...
<td><html:text property="due_date"></html:text></td>
<td colspan="3">
</tr>
